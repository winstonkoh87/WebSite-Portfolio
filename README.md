...
- **Designed** the dark mode aesthetic, glassmorphism cards, particle constellation
- **Wrote** semantic HTML5 with accessibility (skip-links, focus states)
...
CI/CD: HTML validation + broken link checker via GitHub Actions.
